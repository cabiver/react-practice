    ...
    return(<>
        <p>la pagina consiste en hacer un login que pueda guardar fotos, para empezar no sabia js, y sabia que
            era HTML y CSS pero nunca lo habia puesto en practica</p>
                <br/>
        <p>este es mi primer intento de una pagina con fondtend y backend, en la cual consistira en crear un
        usario y contraseña para poder acceder a tu html donde guardaras imagenes</p>
